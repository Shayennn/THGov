...
export const service: Service = {
	...
	faq: [
		...
		},
		{
			...
			a: {
				th: 'ลองเปลี่ยนเครือข่ายก่อนเป็นอันดับแรก ผู้ที่เข้าผ่าน VPN เครือข่ายองค์กร หรือเซิร์ฟเวอร์ในต่างประเทศ อาจถูกระบบกรองทราฟฟิกปฏิเสธ ทั้งที่เว็บไซต์ทำงานปกติสำหรับผู้ใช้ทั่วไป ให้ลองใหม่ด้วยอินเทอร์เน็ตบ้านหรือเน็ตมือถือในประเทศ หากยังไม่ได้ ให้เข้าเว็บไซต์ของกรมที่เกี่ยวข้องโดยตรง เพราะแต่ละกรมใช้คนละเซิร์ฟเวอร์',
				en: 'Change network first. Connections through a VPN, a corporate network or an overseas server can be refused by traffic filtering even while the site works normally for ordinary users. Retry on home broadband or a Thai mobile connection. If it still fails, go straight to the relevant department’s own site — each runs on separate infrastructure.'
			}
		},
		{
	...
	body: [
		...
		},
		{
			type: 'p',
			text: {
				th: 'เว็บไซต์ของกระทรวงสาธารณสุขปฏิเสธการเชื่อมต่อจากเครื่องมือภายนอกที่เราใช้ตรวจสอบ เนื้อหาของเว็บไซต์จึงยากต่อการตรวจสอบหรือเก็บถาวรโดยบุคคลที่สาม และคนบางกลุ่มก็เข้าไม่ถึงในบางเครือข่าย ขณะเดียวกันคำที่คนไทยพิมพ์ค้นหาก็มักเป็นคำถามปลายเปิด เช่น “คลินิกนี้มีใบอนุญาตไหม” หรือ “ข่าวที่แม่ส่งมาจริงหรือเปล่า” มากกว่าจะเป็นชื่อกระทรวงหรือชื่อกรม หน้านี้จึงทำหน้าที่เป็นป้ายบอกทางในภาษาที่คนใช้จริง ระบุว่าเรื่องไหนอยู่กับหน่วยงานใด แล้วส่งต่อไปยังเว็บไซต์ทางการโดยตรง ในเรื่องสุขภาพ การรู้ว่าควรฟังใครสำคัญไม่แพ้ตัวข้อมูลเอง เพราะความเข้าใจผิดครั้งเดียวอาจหมายถึงการรักษาที่ล่าช้าหรือเงินที่เสียไปกับสิ่งที่ไม่ได้ผล THGov เป็นไดเรกทอรีอิสระ ไม่มีความเกี่ยวข้องกับกระทรวงสาธารณสุขหรือหน่วยงานใดของรัฐ เราไม่รับคำร้อง ไม่รับเรื่องร้องเรียน และไม่เก็บข้อมูลส่วนบุคคลแทนหน่วยงานใดทั้งสิ้น',
				en: 'The ministry’s website refuses connections from the outside tools we audit with, which makes its content hard for any third party to verify or archive and leaves some visitors unable to reach it on some networks. Meanwhile the phrases Thai people actually type are open questions — “is this clinic licensed?”, “is the thing my mother forwarded real?” — not the name of a ministry or a department. So this page works as a signpost in ordinary language: it says which body owns which problem, then hands you straight to the official site. In health, knowing whose word to take is worth as much as the information itself, because one misunderstanding can mean delayed treatment or money spent on something that was never going to work. THGov is an independent directory with no affiliation to the Ministry of Public Health or any government body. We do not accept applications, take complaints, or collect personal data on any agency’s behalf.'
			}
		}
	],
	crawl: {

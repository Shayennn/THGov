...
export const service: Service = {
	...
	body: [
		...
		},
		{
			type: 'p',
			text: {
				th: 'คนที่กำลังเดือดร้อนเรื่องบิลมือถือไม่ได้ค้นหาด้วยคำว่า “องค์กรกำกับดูแลกิจการโทรคมนาคม” เขาพิมพ์ว่า “โดนหักเงินค่าบริการที่ไม่ได้สมัคร” หรือ “ยกเลิกบริการเสริมไม่ได้” แล้วสิ่งที่ขึ้นมาก่อนมักเป็นกระทู้เก่าที่ตอบกันไปคนละทาง ระยะห่างระหว่างคำที่คนใช้จริงกับชื่อของหน่วยงานที่มีอำนาจแก้ปัญหา คือเหตุผลตั้งต้นของหน้านี้ และในการตรวจสอบเมื่อวันที่ 28 สิงหาคม 2569 เรายังพบว่าเซิร์ฟเวอร์ของเว็บไซต์ยอมให้อ่านไฟล์ robots.txt แต่ปฏิเสธหน้าเว็บจริงด้วยรหัส 403 ทั้งกับ Googlebot และเบราว์เซอร์ทั่วไป ซึ่งมักเป็นการกรองทราฟฟิกจากศูนย์ข้อมูลมากกว่าการกันเครื่องมือค้นหา แต่ผลในทางปฏิบัติคือไม่มีเครื่องมือภายนอกใดตรวจสอบหรือเก็บถาวรเนื้อหาของเว็บไซต์นี้ได้ หน้านี้จึงเป็นป้ายบอกทางที่ค้นเจอได้ อธิบายด้วยภาษาที่คนใช้จริงว่าหน่วยงานรับเรื่องอะไรและต้องเตรียมอะไรไว้ก่อน แล้วส่งผู้อ่านไปยังเว็บไซต์ทางการโดยตรง THGov เป็นไดเรกทอรีอิสระ ไม่มีความเกี่ยวข้องกับ กสทช. ไม่รับเรื่องร้องเรียนแทนหน่วยงานใด และไม่เก็บข้อมูลส่วนบุคคลของผู้อ่าน',
				en: 'Nobody in the middle of a billing fight searches for “national telecommunications regulator”. They type “charged for something I never subscribed to” or “cannot cancel this add-on”, and what surfaces first is usually an old forum thread pulling in three directions. That gap — between the words people actually use and the name of the body with the power to act — is why this page starts where it does. It is compounded by what we found on 28 August 2026: the site lets an outside tool read robots.txt but answers the real pages with a 403, both to a Googlebot user-agent and to an ordinary browser from our audit host. That shape usually means blanket datacentre filtering rather than a decision to shut search engines out, but the practical result is the same — no outside tool can verify or archive what this site says. So this page acts as the findable signpost: it explains, in the language people use, what the agency handles and what to have ready first, then sends the reader straight to the official site. THGov is an independent directory with no affiliation to the NBTC; we take no complaints on anyone’s behalf and collect no personal data from readers.'
			}
		}
	],
	crawl: {

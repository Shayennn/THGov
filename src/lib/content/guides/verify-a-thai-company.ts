...
export const guide: Guide = {
	...
	steps: [
		{
			...
			text: {
				th: 'เริ่มจากขอเลขทะเบียนนิติบุคคล 13 หลักของบริษัทที่คุณจะทำธุรกิจด้วย ธุรกิจที่จดทะเบียนถูกต้องมีเลขนี้อยู่บนใบเสนอราคา ใบกำกับภาษี และสัญญาอยู่แล้ว หลายแห่งใส่ไว้ท้ายเว็บไซต์ด้วย ถ้าอีกฝ่ายบ่ายเบี่ยง นั่นคือคำตอบ',
				en: 'Start by asking for the 13-digit juristic person registration number. A properly registered business already prints it on quotations, tax invoices and contracts, and many put it in the website footer. If the other side dodges the question, you have your answer.'
			}
		},
		{
			title: { th: 'ค้นในทะเบียนทางการด้วยตัวเอง', en: 'Search the official registry yourself' },
			text: {
				th: 'เปิดระบบค้นข้อมูลนิติบุคคลของกรมพัฒนาธุรกิจการค้าเอง โดยพิมพ์ที่อยู่เว็บไซต์หรือกดลิงก์ทางการจากหน้านี้ อย่าใช้ลิงก์หรือภาพหน้าจอที่คู่ค้าส่งมา เพราะทำเลียนแบบได้ไม่ยาก',
				en: 'Open the Department of Business Development’s company search yourself — type the address, or use the official link on this page. Never rely on a link or a screenshot the counterparty sends you; both are easy to fake.'
			}
		},
		{
			title: { th: 'อ่านสถานะกิจการเป็นอันดับแรก', en: 'Read the status line first' },
			text: {
				th: 'สิ่งแรกที่ต้องอ่านคือสถานะของนิติบุคคล ว่ายังดำเนินกิจการอยู่ เลิกกิจการแล้ว หรืออยู่ระหว่างชำระบัญชี เพราะคนยังออกใบเสนอราคาในนามบริษัทที่เลิกไปแล้วได้ แต่คุณจะไม่มีคู่สัญญาให้ตามทวงจริง',
		...
		},
		{
			...
			text: {
				th: 'อ่านชื่อจดทะเบียน ที่ตั้งสำนักงาน วันจดทะเบียน และประเภทธุรกิจ แล้ววางเทียบกับสิ่งที่อีกฝ่ายเล่า บริษัทที่อ้างว่ามีโรงงานและทีมนับร้อย แต่จดทะเบียนไว้ที่ห้องชุดพักอาศัย ไม่ได้แปลว่าโกง แต่แปลว่ามีคำถามที่ต้องถาม',
		...
		},
		{
			...
			text: {
				th: 'ตรวจรายชื่อกรรมการและเงื่อนไขการลงนาม แล้วเทียบกับคนที่จะเซ็นสัญญากับคุณ หลายบริษัทกำหนดให้กรรมการสองคนลงนามร่วมกันพร้อมประทับตรา ถ้าลงนามไม่ครบ อาจกลายเป็นข้อโต้แย้งภายหลัง',
				en: 'Check the directors and the signing condition, then match them against whoever is about to sign for you. Many companies require two directors signing jointly with the seal, and a document signed outside that condition can be argued over later.'
			}
		},
		{
			title: { th: 'เปิดงบการเงิน แล้วดูแค่สามอย่าง', en: 'Open the accounts and look at three things' },
			text: {
				th: 'ไม่ต้องอ่านเป็นนักบัญชีก็ได้ประโยชน์ เปิดงบที่นำส่งไว้หลายปีเรียงกัน แล้วดูสามอย่าง คือมีรายได้เกิดขึ้นจริงไหม ตัวเลขนิ่งใกล้ศูนย์เหมือนไม่ได้ทำอะไรหรือเปล่า และหนี้สินสูงผิดส่วนกับส่วนของผู้ถือหุ้นแค่ไหน',
		...
		},
		{
			...
			text: {
				th: 'ก่อนกดยืนยันการโอน ให้ดูว่าชื่อบัญชีปลายทางตรงกับชื่อนิติบุคคลที่เพิ่งตรวจหรือไม่ ถ้าเป็นชื่อบุคคลธรรมดา ชื่อบริษัทอื่น หรือสะกดต่างไปเล็กน้อย ให้หยุดแล้วถามเหตุผลก่อน',
		...
		},
		{
			...
			text: {
				th: 'บันทึกภาพหน้าจอข้อมูลทะเบียนพร้อมวันที่ตรวจ แล้วเก็บใบเสนอราคา บทสนทนา และเลขบัญชีไว้ที่เดียวกัน ถ้ามีปัญหา นี่คือสิ่งที่ธนาคารและตำรวจจะขอดูเป็นอย่างแรก',
	...
	body: [
		...
		},
		{
			type: 'p',
			text: {
				th: 'เรื่องที่จบไม่สวยส่วนใหญ่ไม่ได้เริ่มจากสัญญาซับซ้อน แต่เริ่มจากการโอนมัดจำให้บริษัทที่ไม่เคยเจอหน้ากัน เพราะราคาดี ตอบไว และคุยในแชทได้น่าเชื่อถือ ข้อมูลทะเบียนนิติบุคคลของไทยเปิดให้ค้นดูฟรี และตอบได้ในไม่กี่นาทีว่าบริษัทนี้มีตัวตนตามกฎหมายไหม และยังเปิดดำเนินการอยู่หรือเปล่า',
				en: 'Most of these stories do not begin with a complicated contract. They begin with a deposit sent to a company nobody has met, because the price was good, the replies were fast and the chat felt professional. Thailand’s company registry is public and free, and within minutes it answers the two questions that matter most: does this entity legally exist, and is it still operating?'
			}
		},
		{
			type: 'h2',
		...
		},
		{
			type: 'p',
			text: {
				th: 'นิติบุคคลที่จดทะเบียนในไทยทุกรายมีเลขทะเบียน 13 หลักประจำตัว ไม่ซ้ำกับรายอื่น และไม่เปลี่ยนแม้บริษัทจะย้ายที่อยู่หรือเปลี่ยนชื่อ โดยทั่วไปยังใช้เป็นเลขประจำตัวผู้เสียภาษีของนิติบุคคลด้วย จึงแม่นกว่าการค้นด้วยชื่อ ซึ่งมีชื่อคล้ายกันอยู่เต็มไปหมด',
		...
		},
		{
			type: 'ul',
			items: [
				{ th: 'ใบเสนอราคา ใบกำกับภาษี และใบเสร็จรับเงิน', en: 'Quotations, tax invoices and receipts' },
				...
				{ th: 'หัวจดหมายและเอกสารที่ออกในนามนิติบุคคล', en: 'Letterheads and other documents issued by the entity' }
			]
		},
		{
			type: 'h2',
		...
		},
		{
			type: 'p',
			text: {
				th: 'คู่มือนี้มีไว้สำหรับจังหวะที่คุณกำลังจะฝากอะไรบางอย่างไว้กับคนที่ยังไม่รู้จัก เช่น โอนมัดจำค่าสินค้า ว่าจ้างผู้รับเหมา รับข้อเสนองานจากบริษัทที่เพิ่งติดต่อมา หรือปล่อยสินค้าล็อตใหญ่ก่อนได้เงินครบ',
				en: 'This guide is for the moment before you hand something over to a party you do not know: a deposit on goods, a contract with a builder, a job offer from a company that appeared out of nowhere, or a large order released to a new customer on credit.'
			}
		},
		{
			type: 'callout',
			...
			text: {
				th: 'ทะเบียนนี้ครอบคลุมบริษัทจำกัด ห้างหุ้นส่วน และบริษัทมหาชน แต่ไม่รวมผู้ประกอบการบุคคลธรรมดา ร้านค้า หรือฟรีแลนซ์ที่ไม่ได้จดทะเบียน การค้นไม่พบจึงไม่ได้แปลว่าเป็นมิจฉาชีพเสมอไป แต่แปลว่าคุณจะไม่มีข้อมูลทะเบียนช่วยยืนยัน',
		...
		{
			type: 'table',
			caption: { th: 'สัญญาณที่พบบ่อย และสิ่งที่ควรทำต่อ', en: 'Common signals, and what to do about them' },
			head: [
				{ th: 'สัญญาณ', en: 'Signal' },
			...
			rows: [
				[
					...
					{ th: 'ไม่อยากให้ตรวจ หรือไม่ได้จดทะเบียน', en: 'Does not want checking, or was never incorporated' },
				...
				[
					...
					{ th: 'ขอชื่อจดทะเบียนเต็มแล้วค้นซ้ำ', en: 'Ask for the full registered name and search again' }
				],
				[
				...
				[
					...
					{ th: 'แบ่งจ่ายตามงวดงาน', en: 'Pay in stages against delivery' }
				],
				[
					...
					{ th: 'ขอผลงานและหลักฐานการค้า', en: 'Ask for references and trading evidence' }
				]
			]
		},
		{
		...
		},
		{
			...
			text: {
				th: 'ทะเบียนที่ตรวจมาทั้งหมดไม่ช่วยอะไร ถ้าเงินไม่ได้ไปถึงนิติบุคคลรายนั้นจริง ถ้าชื่อบัญชีปลายทางไม่ตรงกับชื่อบริษัทในสัญญา ให้ถือว่ายังไม่ควรโอน คำอธิบายว่าเป็นบัญชีของกรรมการหรือบัญชีสำรอง ไม่ใช่คำตอบที่ตรวจสอบได้ และเงินที่เข้าบัญชีบุคคลธรรมดาคือเงินที่ตามคืนยากที่สุด',
				en: 'Everything you checked in the registry counts for nothing if the money never reaches that entity. If the receiving account name does not match the company named in the contract, the transfer should wait — and being told it is a director’s account, or a temporary backup, is not an explanation you can verify. Money paid into an individual account is the hardest money to get back.'
			}
		},
		{
			type: 'h2',
		...
		},
		{
			type: 'p',
			text: {
				th: 'ข้อมูลทะเบียนนิติบุคคลและงบการเงินที่นำส่งไว้เป็นข้อมูลเปิด ค้นดูได้ฟรีจากระบบของกรมพัฒนาธุรกิจการค้า เว็บไซต์เอกชนที่ขึ้นเป็นผลค้นหาอันดับต้น ๆ มักนำข้อมูลชุดเดียวกันไปจัดหน้าใหม่แล้วเก็บค่ารายงาน บางแห่งยังไม่ตรงกับทะเบียนปัจจุบัน',
				en: 'Registration records and filed financial statements are open data, free to search in the Department of Business Development’s own system. Many of the private sites ranking highest in search results simply repackage that same data and charge for a report, and some serve copies that no longer match the register.'
			}
		}
	],
	faq: [
		{
			...
			a: {
				th: 'ให้ถือเป็นสัญญาณเตือน ธุรกิจที่จดทะเบียนถูกต้องใช้เลขนี้ออกเอกสารอยู่ทุกวัน จึงไม่มีเหตุผลต้องปิดบัง ลองขอใบเสนอราคาหรือใบกำกับภาษีที่มีเลขนี้อยู่แล้ว ถ้ายังบ่ายเบี่ยง ทางที่ปลอดภัยที่สุดคือยังไม่โอนเงิน',
		...
		},
		{
			...
			a: {
				th: 'ไม่เสมอไป สาเหตุที่พบบ่อยคือสะกดไม่ตรงกับชื่อจดทะเบียน ใช้ชื่อทางการค้าคนละชื่อ เป็นผู้ประกอบการบุคคลธรรมดา หรือเป็นบริษัทต่างประเทศ ให้ค้นด้วยเลข 13 หลักซึ่งแม่นกว่า ถ้ายังไม่พบทั้งเลขและชื่อเต็ม นั่นคือจุดที่ควรหยุด',
		...
		},
		{
			...
			a: {
				th: 'ให้รีบที่สุด ติดต่อธนาคารของคุณทันทีเพื่อแจ้งเหตุและสอบถามเรื่องการอายัดบัญชีปลายทาง เพราะโอกาสตามเงินคืนลดลงเร็วตามเวลาที่ผ่านไป จากนั้นรวบรวมสลิปโอนเงิน บทสนทนา และข้อมูลบัญชีปลายทางไปแจ้งความ อย่าโอนเพิ่มเพื่อปลดล็อกเงินก้อนเดิม เพราะนั่นคือขั้นต่อไปของกลโกงเดียวกัน',
				en: 'Move fast. Contact your bank immediately to report it and ask about freezing the receiving account — the odds of recovery fall away quickly with time. Then take the transfer slips, chat history and recipient account details to the police. Do not send more money to unlock what you already sent; that is the next step of the same scam.'
			}
		}
	],
	updated: '2026-08-28',
